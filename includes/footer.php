        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="/proyecto/auth/logout.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="passwordChangedModal" tabindex="-1" role="dialog"
        aria-labelledby="passwordChangedLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">

                <div class="modal-header">
                    <h5 class="modal-title" id="passwordChangedLabel">
                ...
                <div class="modal-footer">
                    <a class="btn btn-primary" href="logout.php">
                        Aceptar y volver a iniciar sesión
                    </a>
                </div>
    ...
    <script src="/proyecto/js/demo/chart-area-demo.js"></script>
    <script src="/proyecto/js/demo/chart-pie-demo.js"></script>
